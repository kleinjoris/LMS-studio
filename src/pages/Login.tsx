            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  className="block w-full rounded-md border border-gray-300 py-2 pl-10 pr-3 placeholder-gray-400 focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
